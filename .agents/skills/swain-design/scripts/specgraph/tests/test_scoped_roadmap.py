...
def _make_scoped_graph():
    ...
    nodes = {
        "VISION-001": {
            ...
            "file": "docs/vision/Active/(VISION-001)-Core/v.md",
            "brief_description": "",
        },
        "INITIATIVE-001": {
            "type": "Initiative",
            "title": "Auth System",
            "status": "Active",
            "file": "docs/initiative/Active/(INITIATIVE-001)-Auth/i.md",
            "brief_description": "Harden authentication",
        },
        "INITIATIVE-002": {
            "type": "Initiative",
            "title": "Observability",
            "status": "Active",
            "file": "docs/initiative/Active/(INITIATIVE-002)-Obs/i.md",
            "brief_description": "",
        },
        "EPIC-001": {
            "type": "Epic",
            "title": "Login Flow",
            "status": "Active",
            "file": "docs/epic/Active/(EPIC-001)-Login/e.md",
        },
        "EPIC-002": {
            "type": "Epic",
            "title": "SSO",
            "status": "Active",
            "file": "docs/epic/Active/(EPIC-002)-SSO/e.md",
        },
        "SPEC-001": {
            "type": "Spec",
            "title": "Login API",
            "status": "Complete",
            "file": "docs/spec/Complete/(SPEC-001)-Login-API/s.md",
        },
        "SPEC-002": {
            "type": "Spec",
            "title": "Login UI",
            "status": "Active",
            "file": "docs/spec/Active/(SPEC-002)-Login-UI/s.md",
        },
        "SPEC-DIRECT": {
            "type": "Spec",
            "title": "Direct Spec",
            "status": "Active",
            "file": "docs/spec/Active/(SPEC-003)-Direct/s.md",
        },
    }
    edges = [
